<div class="add-tutorial">
    <h2 class="title title--admin-page">Add new tutorial:</h2>
    ...
    <form wire:submit.prevent="submit" class="add-tutorial__form">
        ...
        <div class="form-group">
            <button class="button button--admin-page" type="submit">Dodaj Tutorial</button>
        </div>
    </form>
</div>